...
Installation;
 ...
 2- Checkout latest codebase of eufy-security-ws: `git clone https://github.com/fuatakgun/eufy-security-ws` - I have created a Pull Request into original codebase to get instant updates on thumbnails. Until it is merged, you can use my clone codebase.
